...
class MLhelper_SX1278 : public MLhelper_base {
  public:
	MLhelper_SX1278()
	{
	...
	int write(byte* buf, uint8_t len)
	{
		beginPacket();
		// check len
	...
	void onInternalRxDone(void(*callback)(int))
	{
	...
	void onInternalTxDone(void(*callback)())
	{
